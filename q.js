(function () {
    ...
    function initJacredQualitySystem(jacredUrl) {
        ...
        function addQualityToMiniCard(cardElement, cardData) {
            ...
            // свой класс, не трогаем нативные .card-quality
            var existing = cardElement.querySelectorAll('.jacred-card-quality');
            ...
            var qualityElement = existing[0];

            if (!qualityElement) {
                qualityElement = document.createElement('div');
                qualityElement.className = 'jacred-card-quality';
            ...
            function applyQuality(quality, isCamrip) {
                ...
                if (isCamrip) qualityElement.classList.add('jacred-card-quality_cam');
                else qualityElement.classList.remove('jacred-card-quality_cam');
            }
