(function () {
    ...
    var _html_home = '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-house-door" viewBox="0 0 16 16">' +
        '<path d="M8.354 1.146a.5.5 0 0 0-.708 0l-6 6A.5.5 0 0 0 1.5 7.5v7a.5.5 0 0 0 .5.5h4.5a.5.5 0 0 0 .5-.5v-4h2v4a.5.5 0 0 0 .5.5H14a.5.5 0 0 0 .5-.5v-7a.5.5 0 0 0-.146-.354L13 5.793V2.5a.5.5 0 0 0-.5-.5h-1a.5.5 0 0 0-.5.5v1.293L8.354 1.146ZM2.5 14V7.707l5.5-5.5 5.5 5.5V14H10v-4a.5.5 0 0 0-.5-.5h-3a.5.5 0 0 0-.5.5v4H2.5Z"/>' +
        '</svg>' +
        '<div class>Home</div>';

    var _html_component = '<svg fill="currentColor" width="800px" height="800px" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">' +
    ...
    var cssRulesColor = '.torrent-filter .simple-button--filter:nth-last-child(4) {border-color: red;}' +
    ...
    Navigator.navigableFilter = function (el) { return el.classList.contains('hide') ? false : true };
    ...
    var plugTvKeys = {
        ...
        _customButton_home: function(e) {
            ...
            tfilter = tfilter ? tfilter.querySelector('.torrent-filter') : null;
            if (tfilter != null) {
                tfilter.children[tfilter.children.length - 4].on('hover:enter', function() {
                    var active = Lampa.Storage.get('activity', 'false');
                    var start_from = Lampa.Storage.field("start_page");
                    var start_from_split = start_from.split('@');
                    var action = start_from_split[0];
                    var type = start_from_split[1];
        ...
        start: function () {
            ...
            Lampa.Listener.follow('activity', Lampa.Storage.get('apx_customButton', {}) == 'component' ? 
                this._customButton_comp.bind(this) : this._customButton_home.bind(this));
            if (Lampa.Storage.get('apx_reBindRight', {}) == true) {
